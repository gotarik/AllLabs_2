    ...
    public partial class init2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RentalSystemIdPK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdministratorIdPK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RentalSystemIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarIdPK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClientIdPk = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RentalSystemIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PassportData = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderIdPK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ClientIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RentalSystemIdPK = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
